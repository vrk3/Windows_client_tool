...
RIBBON: tuple = (
    ...
    ("Tools", (
        ...
        ("Tools", (("tools.search", "Open TreeSize File Search", False, True),
                   ("tools.duplicates", "Find duplicate files", False, False),
...
MENUS: dict = {
    ...
    "tools.search": (("tools.search.open", "Find files\u2026"),
                     ("tools.duplicates", "Find duplicate files\u2026")),
